package com.pengdaijun.demo.spring.swagger.autoconfig.config;
...
public class SwaggerConfig {
  ...
  private ApiInfo apiInfo() {
    ...
    apiInfoBuilder.version("0.0.1-SNAPSHOT");
		// apiInfoBuilder.contact(new Contact("Ferdi Sonmezay",
		// "https://ferdisonmezay.com", "hi@ferdisonmezay.com"));
